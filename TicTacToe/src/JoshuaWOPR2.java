 ...
 */
public class JoshuaWOPR2 implements IPlayer {
	...
	public int[] makeMove(IBoard board) {
		...
		/*
		System.out.print("F: ");
		for (int i = 0; i < PrevBoardFeatures.length; i++) {
	...
	private int[] getBoardFeatures(IBoard board){
		...
		//TODO: check for diagonals spanning through layers
	...
	private int[] addToFeatures(int[] features, int counterMine, int counterEnemy) {
		 ...
		 * How does this work? e.g. if I count 2 X and zero O I add a 1 to feature x1 & x2
		 * This is because taking away something from x1 (when adding a X into the board) skews the board score
		*/
		// features for me
	...
	// train our learned function, during the game trainValue is the prev value and boardValue the current
